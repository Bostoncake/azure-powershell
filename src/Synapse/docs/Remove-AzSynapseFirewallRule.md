...
### Delete (Default)
```
Remove-AzSynapseFirewallRule -ResourceGroupName <String> -RuleName <String> -WorkspaceName <String>
...
### DeleteViaIdentity
```
Remove-AzSynapseFirewallRule -InputObject <ISynapseIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
