...
Updates a firewall rule.
#>
function New-AzSynapseFirewallRule_CreateViaSwitchParameterAllowAllAzureIp {
    ...
    param(
        ...
        [Parameter(Mandatory, HelpMessage = "Allow all Azure IPv4 Ip.")]
    ...
    process {
        try {
            ...
            $null = $PSBoundParameters.Remove('AllowAllAzureIp')
